                ...
                <div class="col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <a href="index.php">Accueil</a> > <a href="liste_if.php">Liste des Identifiants Fiscal </a>
                        </li>
                    ...
                    <div class="page-header">
                        <h1 class="page-title">Liste des Identifiants Fiscal</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" >
                                    ...
                                    <tr>
                                        ...
                                        <th>siege</th>
                                        <th>activité </th>
                                        <th>Numero de Identifant fiscal</th>
                                    ...
                                    <?php 
                                    $result = $db->prepare("SELECT * FROM identifiantsfiscales");
                                    $result->execute();
