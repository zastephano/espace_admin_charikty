                ...
                <div class="col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <a href="index.php">Accueil</a> > <a href="liste_patente.php">Liste des patentes </a>
                        </li>
                    ...
                    <div class="page-header">
                        <h1 class="page-title">Liste des patentes</h1>
                        ...
                        <div class="panel panel-white demo-panel" style="width:100%;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" >
                                    ...
                                    <?php 
                                    $result = $db->prepare("SELECT * FROM patentes");
                                    $result->execute();
